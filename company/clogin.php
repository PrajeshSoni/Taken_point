  ...
  <div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold"> company Login</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php">Home</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong> company Log In</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <form action="clogin_code.php" method="POST" class="p-4 p-md-5 border rounded">
