...
if (!isset($_SESSION['com_id'])) {
    ...
    $q = "select a.*,u.u_name,p.title from apply a,users u,job_posting p where a.u_id=u.u_id and a.post_id=p.post_id and a.post_id = '$post_id' ";
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><a href="ceditapply.php?ap_id=<?php print $row['ap_id']; ?>" style="color: black"> Edit</a>
                            </tr>
                        <?php } ?>
                        </tbody>
                </table>
