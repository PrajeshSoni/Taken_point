        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <a href="job-listings.php">Job list</a> <span class="mx-2 slash">/</span>
          ...
          <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-4">
              <div class="row">
                ...
                <div class="col-6">
                  <a href="login.php" class="btn btn-block btn-primary btn-md">Sign in</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="mb-5">
                ...
                <ul class="list-unstyled m-0 p-0">
                  <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>
                      <?php print $row['edu_level']; ?>
                    </span></li>
                  <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>
                      <?php print $row['min_salary']; ?> To <?php print $row['max_salary']; ?>
                    </span></li>
                </ul>
              </div>
              ...
              <div class="bg-light p-3 border rounded mb-4">
                ...
                <ul class="list-unstyled pl-3 mb-0">
                  ...
                  <li class="mb-2"><strong class="text-black">Salary:</strong>
                    <?php print $row['min_salary']; ?> - <?php print $row['max_salary']; ?>
                  </li>
                  <li class="mb-2"><strong class="text-black">Gender:</strong> Any</li>
                  <li class="mb-2"><strong class="text-black">post By</strong>
                    <?php print $row['post_by']; ?>
                  </li>
                </ul>
              </div>
            <?php }
        ...
        <div class="owl-carousel single-carousel">
              ...
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;I find Taken Point very helpful. it was a great project and good people to work with
                    . Really
                    appriciate the team who helped me find this project which built my experience in the It
                    industry.&rdquo;</p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;I have worked with Taken Point recently , and they are good at providing service.
                    They are
